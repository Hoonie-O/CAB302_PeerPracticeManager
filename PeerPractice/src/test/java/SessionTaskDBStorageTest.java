...
public class SessionTaskDBStorageTest {

    private SessionTaskDBStorage storage;
    private IUserDAO userDao;
    private User testUser1;
    private User testUser2;
    private Session testSession;
    private SessionCalendarDBStorage sessionStorage;
    ...
    void setUp() throws SQLException {
        userDao = new UserDAO();
        storage = new SessionTaskDBStorage(userDao);
        sessionStorage = new SessionCalendarDBStorage(userDao);
